    ...
    <main class="wf-main">
      <section class="wf-hero">
        ...
        <div class="wf-cta">
          ...
          <a class="wf-btn wf-btn-ghost" href="https://github.com/Webflow-Examples/hello-world-vue-app-bindings" target="_blank" rel="noreferrer">
            View on GitHub
          </a>
        </div>
      </section>
